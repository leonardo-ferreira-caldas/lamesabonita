                ...
                <div class="col_full nobottommargin noabsolute menu-detalhe-wrapper">
                    ...
                    <div class="padding20px notoppadding bottommargin-lg norightpadding">
                        ...
                        <div class="text-center reserva-concluida topmargin-lg">
                            <i class="fa fa-times-circle-o reserva-reprovada-icon"></i>
                            <h3 class="nobottommargin roboto fontlight darkgray font-lg">{{ $reserva->nome_cliente }}, seu cartão foi recusado!</h3>
                            <h5 class="roboto informacoes-reserva darkgray fontlight">Entre em contato com a sua operadora de cartão de crédito para entender melhor o que houve.</h5>
                        </div>
