...
return [
    ...
    */
    ...
    'attributes' => [
        ...
        'ind_toda_cidade'           => "'aceiterei reservas em toda cidade'",
        'fk_banco'                  => 'banco',
        'banco_conta'               => 'conta corrente',
        'banco_proprietario_conta'  => 'proprietário da conta',
        'prato_principal'           => 'prato principal',
        'entrada'                   => 'prato de entrada',
        'aperitivo'                 => 'aperitivos',
        'sobremesa'                 => 'sobremesa',
        'incluso_preco'             => "'o que está incluso no preço'",
        'data_nascimento'           => 'data de nascimento',
        'message'                   => 'mensagem',
        'subject'                   => 'assunto',
        'telefone'                  => 'telefone',
        'titulo'                    => 'titulo',
        'qtd_maxima_cliente'        => 'quantidade máxima de convidados',
        'checkbox-terms'            => 'termos de uso',
        'sobre_chef'                => 'sobre o chef'
    ],
